                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" name="bold_text" id="" class="form-control input-lg" required></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Small Text</label>
                                    <div class="col-sm-6"><input type="text" name="small_text" id="" class="form-control input-lg" required></div>
                                </div>
                                <br><br>

                                <div class="row">
                                    <div class="col-md-offset-3 col-md-6">
                                        <button type="submit" class="btn blue btn-block margin-top-10"><i class="fa fa-send"></i> Save Slider</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('delete_slider') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}

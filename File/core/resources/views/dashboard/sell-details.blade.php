                    ...
                    <section class="content">
                        <section class="content invoice">
                                ...
                                <div class="col-xs-12 table-responsive">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $sell->buy->currency->name }}</td>
                                            <td>{{ $sell->buy->quantity}} - {{ $sell->buy->currency->name }}</td>
                                            <td>{{ $sell->buy->currency->sell_rate * $sell->buy->quantity}} - {{ $base_currency }}</td>
                                            <td>{{ $sell->transaction_details }}</td>
                                            <td>{{ $sell->name }}</td>
                                            <td>{{ $sell->email }}</td>
                                            <td>
                                                @if($sell->status == 0)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <img style="width: 100%;height: 300px" src="{{ asset('images') }}/{{ $sell->image }}" alt="">
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $sell->buy->currency->sell_rate * $sell->buy->quantity}} - {{ $base_currency }}
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                ...
                <div class="modal-footer">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="name" value="{{ $sell->name }}" class="form-control input-lg" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="email" value="{{ $sell->email }}" class="form-control input-lg" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="DelModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('admin-buy-update') }}" class="form-inline">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" class="abir_id" value="0">
